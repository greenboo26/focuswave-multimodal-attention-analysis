# B1-late to B2-early recovery — method card

## Purpose

Define the scientific question and report role for B1-late to B2-early recovery. This card records existing work only; it does not authorize a new exploratory run.
