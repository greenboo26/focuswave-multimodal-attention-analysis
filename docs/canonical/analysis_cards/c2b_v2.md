# C2b-v2 canonical mmWave absolute features — method card

## Purpose

Define the scientific question and report role for C2b-v2 canonical mmWave absolute features. This card records existing work only; it does not authorize a new exploratory run.
