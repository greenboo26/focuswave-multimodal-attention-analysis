# Cross-site validation — method card

## Purpose

Define the scientific question and report role for Cross-site validation. This card records existing work only; it does not authorize a new exploratory run.
