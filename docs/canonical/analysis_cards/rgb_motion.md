# RGB Motion — method card

## Purpose

Define the scientific question and report role for RGB Motion. This card records existing work only; it does not authorize a new exploratory run.
