# NIR 69-session fullclass engineering — method card

## Purpose

Define the scientific question and report role for NIR 69-session fullclass engineering. This card records existing work only; it does not authorize a new exploratory run.
