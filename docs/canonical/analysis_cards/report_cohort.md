# REPORT_ANALYSIS_COHORT — method card

## Purpose

Define the scientific question and report role for REPORT_ANALYSIS_COHORT. This card records existing work only; it does not authorize a new exploratory run.
