# M1 person-effect audit — method card

## Purpose

Define the scientific question and report role for M1 person-effect audit. This card records existing work only; it does not authorize a new exploratory run.
...
- **Question:** 个体效应是否解释主要瓶颈
- **Producer:** scripts/build_evaluate_j_mmwave_m1_loso.py
- **Inputs / required columns:** m1_mmwave_person_effect_variance_audit_v1 aggregate outputs
- **Cohort and unit:** participant-disjoint M1/Q0
- **Model / validation:** LOSO/variance diagnostic
- **Execution role and boundary:** supplementary diagnostic
