# Four-class probe trajectory — method card

## Purpose

Define the scientific question and report role for Four-class probe trajectory. This card records existing work only; it does not authorize a new exploratory run.
