...
|---|---|---|---|---|
| MMWAVE_ECG_VALID_SPECTRAL_TRUTH_AUDIT_20260830 | PARTIAL / SUPPORTING_ONLY | [Issue #27 ECG_VALID retrospective spectral truth audit](../results/2026-08-30_MMWAVE_TARGETED_VALIDATION/ECG_VALID_SPECTRAL_AUDIT_REPORT_2026-08-30.md) | `D:\Project\厚粲杯\11_数据\derived\ecg_valid_retrospective_spectral_truth_audit_20260830` | 335-window diagnostic/supporting spectral truth table; #24 ECG_VALID primary n=325, ECG_INVALID n=10, UNRESOLVED n=0; no HR/BR promotion |
| MMWAVE_ISSUE29_SUPERVISOR_20260830 | REUSE_GATE=PASS / SCIENTIFIC_GATE=PARTIAL; canonical `c2150c9bb5bb4509b09b9b7be0ada956c3e222cc` | [Issue #29 supervisor round 1](../results/2026-08-30_MMWAVE_ISSUE29_SUPERVISOR/MMWAVE_ISSUE29_SUPERVISOR_ROUND1.md) | `D:\Project\厚粲杯\11_数据\derived\mmwave_issue29_supervisor_20260830` — `REPO_RECORDED_NOT_MACHINE_VERIFIED` | #24–#28 execution evidence and denominator boundaries audited; HR/BR HOLD, HRV BLOCKED; no formal validity promotion; local execution SHA retained only in the supervisor manifest as `LOCAL_EXECUTION` |
...
All local paths are external to Git. A path is `VERIFIED_ON_EXECUTING_MACHINE` only when this machine check is recorded; otherwise it remains `REPO_RECORDED_NOT_MACHINE_VERIFIED`. Ephemeral worktree and paste-output paths are not durable result locations.

## Issue #24–#29 canonical provenance map (2026-08-30)

| issue | local execution SHA (provenance only) | integrated canonical `main` SHA | canonical report / manifest | local-only result path | status |
|---|---|---|---|---|---|
| #24 | `d2d09f8ac502600d3a1241e33c429bd53756fa45` (`LOCAL_EXECUTION`) | `6b45a0829bb18e69a65eff3b987c548fe93b8de6` | `docs/results/2026-08-30_MMWAVE_TARGETED_VALIDATION/ECG_ELIGIBILITY_MANIFEST.json` | manifest records an ephemeral row-level path under `C:\Users\550ACW\.codex\worktrees\0ce8\08_算法\work\...` — `EPHEMERAL_OR_STALE`; no stable local result root verified | FROZEN upstream: 325/10/0 |
| #25 | `c4b5397971c98270520b1eec9ec81cda8592e9dd` (`LOCAL_EXECUTION`) | `4986ca32716fe415c01b518587b031da55d481c1` + `65b8e6547394be9c5bddba823ca7c72ce8e7ab38` | `MMWAVE_WINDOW_LENGTH_COMPARISON_MANIFEST.json` / report | stable local output root not machine-verified in this execution | PARTIAL / DIAGNOSTIC_ONLY; WAIT_ON_SELECTOR_VALIDITY |
| #26 | `6990364151d544d54b297ce394b4ff9e5f20c1d7` (`LOCAL_EXECUTION`) | `d6b091756bb539f0cde426586444b41764888bdb` | `MMWAVE_DISTANCE_ERROR_PHYSICAL_GATE_MANIFEST.json` / report | stable local output root not machine-verified in this execution | PARTIAL; PHYSICAL_GATE_UNRESOLVED / HARD_EXTERNAL_BLOCKER |
| #27 | `72140e8ea7ed99ecb0e668c632a4247305231d3d` (`LOCAL_EXECUTION`) | `2647ceeb90034fc461bba668728e478927220de5` | `ECG_VALID_SPECTRAL_AUDIT_MANIFEST.json` / report | `D:\Project\厚粲杯\11_数据\derived\ecg_valid_retrospective_spectral_truth_audit_20260830` — `VERIFIED_ON_EXECUTING_MACHINE` | PARTIAL / SUPPORTING_ONLY |
| #28 | `92f47305570622cd64ddd4b375b797b4614a5ce3` (`LOCAL_EXECUTION`) | `9bc423de70f19abab2a75f93c7a31d4d95a0a189` | `MMWAVE_ACQUISITION_TAIL_AUDIT_MANIFEST.json` / report | `D:\Project\厚粲杯\11_数据\derived\issue28-tail-20260830-r1` — `REPO_RECORDED_NOT_MACHINE_VERIFIED` | PARTIAL / HISTORICAL_TAIL_IRRECOVERABLE |
| #29 | `7629952520b0f237b67b6db5d54c8d30ced8a6f8` (`LOCAL_EXECUTION`) | `c2150c9bb5bb4509b09b9b7be0ada956c3e222cc` | `MMWAVE_ISSUE29_SUPERVISOR_MANIFEST.json` / round 1 report | `D:\Project\厚粲杯\11_数据\derived\mmwave_issue29_supervisor_20260830` — `REPO_RECORDED_NOT_MACHINE_VERIFIED` | REUSE_GATE=PASS / SCIENTIFIC_GATE=PARTIAL |
...
| MMWAVE_TARGETED_VALIDATION_20260830 | HISTORICAL_PRE_TIMESTAMP_CONTRACT / SUPERSEDED_FOR_DLL_WINDOWS | `../results/2026-08-30_MMWAVE_TARGETED_VALIDATION/MMWAVE_TARGETED_VALIDATION_REPORT_2026-08-30.md` plus pre-contract diagnostic CSV/JSON/manifest | `D:\acq_mmwave_data\sub-97793_`, `sub-9779_`, `sub-97795_`; first 6000 frames only | historical targeted diagnostic retained; Python-time windows superseded for current DLL-time contract; HR/BR HOLD, HRV/IBI EXCLUDE | producer reference `640cacea31ee54a63de348ddf11ba87834cb0db6` |
| MMWAVE_TIMESTAMP_SEMANTICS_REPAIR_20260830 | PARTIAL / DLL_CONTRACT_FROZEN__WINDOWS_MATERIALLY_CHANGED | `../research/MMWAVE_FRAME_TIME_CONTRACT_2026-08-30.md` and [DLL-time HR sensitivity package](../results/2026-08-30_MMWAVE_TARGETED_VALIDATION/MMWAVE_TIME_SEMANTICS_HR_COMPARISON_REPORT_2026-08-30.md) | `D:\acq_mmwave_data\sub-97793_`, `sub-9779_`, `sub-97795_`; row-level mapping local-only | DLL `receive_data.timeStamp` authoritative by source conversion; 335 windows, 310 changed, 154 obvious; old HR retained as Python-time provenance; HR/BR HOLD, HRV BLOCKED, #16 PAUSED | FocusWave `ecg` `8e6fe5c5d08f386661bc05aaf9d5c5715a43b317`; canonical baseline `ab39ad272462c54208b56e0b302b5d9ff1e95b4c` |
| MMWAVE_DLL_COVERAGE_SENSITIVITY_20260830 | PARTIAL / COVERAGE_NOT_PRIMARY_HR_EXPLANATION | [coverage audit](../results/2026-08-30_MMWAVE_TARGETED_VALIDATION/MMWAVE_DLL_WINDOW_COVERAGE_AUDIT_REPORT_2026-08-30.md) and [S0/S1/S2 sensitivity](../results/2026-08-30_MMWAVE_TARGETED_VALIDATION/MMWAVE_DLL_WINDOW_COVERAGE_SENSITIVITY_REPORT_2026-08-30.md) | `D:\acq_mmwave_data\sub-97793_`, `sub-9779_`, `sub-97795_`; 335 DLL-time windows | frozen timestamp-only contract: 333 COMPLETE / 0 PARTIAL / 2 SEVERELY_INCOMPLETE; S0/S1/S2 MAE changes ≤0.061349 bpm; severe tail localized to 97795/block4; no HR algorithm promotion | canonical `426576e0809252656b79729ac077e91a6bfca80d`; scripts `run_mmwave_dll_window_coverage_audit_20260830.py` and `run_mmwave_dll_window_coverage_sensitivity_20260830.py` |
| MMWAVE_ECG_REFERENCE_ELIGIBILITY_20260830 | PARTIAL / ECG_REFERENCE_ELIGIBILITY_COMPLETE | [ECG eligibility report](../results/2026-08-30_MMWAVE_TARGETED_VALIDATION/ECG_REFERENCE_ELIGIBILITY_REPORT_2026-08-30.md); canonical `6b45a0829bb18e69a65eff3b987c548fe93b8de6` | `D:\acq_mmwave_data\sub-97793_`, `sub-9779_`, `sub-97795_`; 335 DLL-time windows; per-window CSV local-only; path existence not machine-verified here | ECG_VALID=325 / ECG_INVALID=10 / UNRESOLVED=0; ARM0/ARM1/ARM2 ECG_VALID MAE=25.005/21.906332/18.904008 bpm; HR remains HOLD and HRV BLOCKED | pre-integration baseline `805db1d3f2d701d46f678b7cd911990f779a4966` is provenance only; script `run_ecg_eligibility_dll_windows_20260830.py` |
| MMWAVE_ACQUISITION_TAIL_AUDIT_20260830 | PARTIAL / HISTORICAL_TAIL_IRRECOVERABLE | [Issue #28 acquisition tail audit](../results/2026-08-30_MMWAVE_TARGETED_VALIDATION/MMWAVE_ACQUISITION_TAIL_AUDIT_REPORT_2026-08-30.md) | `D:\Project\厚粲杯\11_数据\derived\issue28-tail-20260830-r1` | 11 dirs / 6 auditable / 5 missing required logs; `97795/block4` marker-to-last-DLL gap 24,809 ms; historical tail not recoverable; no #24–#27 denominator change | script `run_mmwave_acquisition_tail_audit_20260830.py` |
