...
| MMWAVE_PIPELINE_AUDIT | PARTIAL_WITH_FORMAL_MODE_CLOSED | `../research/MMWAVE_FORMAL_PIPELINE_LINE_BY_LINE_AUDIT_2026-08-29.md` | `D:\Project\厚粲杯\08_算法\docs\results\2026-08-29_RS6240距离与DataCube审计_v1\` and local SDK assets | formal image is 1D Range-FFT DataCube; calibration, timing, target continuity and HRV remain bounded | `../research/MMWAVE_LITERATURE_VS_PROJECT_STAGE_MATRIX_2026-08-29.csv` |
