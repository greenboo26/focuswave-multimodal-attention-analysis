...
| clean clone passes | BLOCKED | no clean-clone cutover run executed in this small fix |
...
Overall: `REPOSITORY_CUTOVER_READY = BLOCKED`. This is expected and is not authorization to create `main`, switch default branch, create tags or delete branches.
