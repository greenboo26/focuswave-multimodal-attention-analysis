...
- local_startup_files: `AGENTS.md` if present, then `ANALYSIS_HISTORY_LEDGER.md`, `docs/canonical/ANALYSIS_PROGRESS_MAP_2026-08-28.md`, `docs/canonical/MMWAVE_CURRENT_STATE_2026-08-29.md` when mmWave is in scope, then `README.md`, `docs/00_治理/`, and current status/handoff
