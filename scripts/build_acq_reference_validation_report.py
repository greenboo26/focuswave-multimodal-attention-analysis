...
OUT = ROOT / "output" / "ACQ_reference_20260821"
REF_CSV = OUT / "mmwave_vs_reference_probes_60s.csv"
BR_JSON = OUT / "breath_method_comparison_current.json"
REF_METRICS = OUT / "reference_metrics.json"
REPORT = OUT / "ACQ_reference_validation_20260822.md"
