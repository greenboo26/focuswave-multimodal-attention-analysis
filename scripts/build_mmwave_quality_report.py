...
OUTPUT = PROJECT_ROOT / "08_算法" / "output" / "质量分析_行为裁剪_v1"
ACQ = PROJECT_ROOT / "08_算法" / "output" / "ACQ_reference_20260821"
...
"""
    (OUTPUT / "省赛报告_毫米波质量与独立验证_20260823.md").write_text(report, encoding="utf-8")
    summary = {"crop": crop, "task_segment_counts": counts, "task_segments": len(task), "baseline_segments": len(baseline), "acq_reference": acq}
    (OUTPUT / "省赛报告_毫米波质量与独立验证_20260823.json").write_text(json.dumps(summary, ensure_ascii=False, indent=2), encoding="utf-8")
    print(OUTPUT / "省赛报告_毫米波质量与独立验证_20260823.md")
    return 0
