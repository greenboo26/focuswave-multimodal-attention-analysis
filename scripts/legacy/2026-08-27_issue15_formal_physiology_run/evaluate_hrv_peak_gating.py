...
REF=Path(r"D:\Project\厚粲杯\08_算法\output\20_生理金标准验证\01_历史严格参照_v20260821\reference_metrics.json")
ROWS=Path(r"D:\Project\厚粲杯\08_算法\output\20_生理金标准验证\01_历史严格参照_v20260821\mmwave_vs_reference_probes.csv")
ROOT=Path(r"D:\Project\厚粲杯\08_算法\output\20_生理金标准验证\05_毫米波参照_FAST")
OUT=Path(r"D:\Project\厚粲杯\08_算法\work\issue15_formal_physiology_run_2026-08-27\output\hrv_gating_evaluation.json")
FS=100.0
