...
数据:
  输入: output/09_PREEXP-SUB{XXX}-FULL/sub{XXX}_full_windows.json
        + F:/预实验/sub-XXX_/beh/master_timeline.csv
  输出: output/09_PREEXP-SUB000-003-ROBUST/
...
OUTPUT_ROOT = SCRIPT_DIR.parent / "output" / "09_PREEXP-ROBUST-ALL"
