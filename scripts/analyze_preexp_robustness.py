...
SUBJECTS = ["003", "004", "005", "006", "007", "008", "009", "010"]  # 分析集 8 人 (001/002 摆位失误, 000 练习效应, 8-13 定)
SCRIPT_DIR = Path(__file__).resolve().parent
OUTPUT_ROOT = SCRIPT_DIR.parent / "output" / "预实验" / "03_跨被试" / "09_预实验-ROBUST-ALL"
...
def load_windows(subject: str, out_root: Path) -> list[dict]:
    ...
    path = out_root / "02_全程窗" / f"09_预实验-SUB{subject}-FULL-v6" / f"sub{subject}_full_windows.json"
